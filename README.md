...
bashgsutil mb gs://your-bucket-name
...
register.phpのplansByStoreオブジェクトに追加
api.phpのgetPlanDetails()関数に詳細情報を追加
index.phpの該当配列を更新

カスタムフィールドの追加

データベーステーブルにカラム追加
api.phpの$db_column_map配列を更新
フロントエンド（index.php, register.php）のフォーム要素を追加
